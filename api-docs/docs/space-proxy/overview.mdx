...
sidebar_position: 0
title: Space Proxy
description: "A PDS wrapper Habitat offers so developers can experiment with the ATProto permissioned data proposal before spaces are natively supported by PDSs."
---
...
Make sure to reference the [permissioned data proposal](https://github.com/bluesky-social/proposals/blob/main/0016-permissioned-data/README.md) for more details. Here's a high-level overview:
