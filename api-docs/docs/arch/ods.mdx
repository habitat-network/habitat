...
sidebar_position: 1
title: Organizational Data Server
description: "The ODS hosts all data and APIs for a Habitat organization, analogous to a Personal Data Server but scoped to the organization rather than a single user."
---
