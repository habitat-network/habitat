...
sidebar_position: 0
title: Introduction
description: "An overview of the primitives Habitat provides — authentication, permissions, and sync — for building products on top of an Organizational Data Server."
---
