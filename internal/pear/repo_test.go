...
func TestRepoListRecords(t *testing.T) {
	...
	records, err := repo.listRecords(nil)
	require.NoError(t, err)
...
func TestRepoListRecordsByOwnersMultipleOwners(t *testing.T) {
	...
	require.NoError(
		t,
		repo.putRecord("bob-did", collection, "bob-rkey1", map[string]any{"data": "bob1"}, nil),
	)
	require.NoError(
		t,
		repo.putRecord("bob-did", collection, "bob-rkey2", map[string]any{"data": "bob2"}, nil),
	)
...
func TestRepoListSpecificRecordsSingleRecord(t *testing.T) {
	...
	require.NoError(
		t,
		repo.putRecord("alice-did", collection, "rkey1", map[string]any{"data": "alice1"}, nil),
	)
...
func TestRepoListSpecificRecordsMultipleFromSameOwner(t *testing.T) {
	...
	require.NoError(
		t,
		repo.putRecord("alice-did", collection, "rkey2", map[string]any{"data": "alice2"}, nil),
	)
...
func TestRepoListSpecificRecordsMultipleOwners(t *testing.T) {
	...
	require.NoError(
		t,
		repo.putRecord("bob-did", collection, "rkey2", map[string]any{"data": "bob2"}, nil),
	)
	require.NoError(
		t,
		repo.putRecord("charlie-did", collection, "rkey1", map[string]any{"data": "charlie1"}, nil),
	)
...
func TestRepoListSpecificRecordsFiltersByCollection(t *testing.T) {
	...
	require.NoError(
		t,
		repo.putRecord("alice-did", otherCollection, "rkey1", map[string]any{"data": "like1"}, nil),
	)
