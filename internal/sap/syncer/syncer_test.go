...
func TestVerifierSignerWebAuthor(t *testing.T) {
	...
	tag, _, err := v.signer(t.Context(), space, authorDID)
	require.NoError(t, err)
	require.Equal(t, spacecommit.SpecProtocolTag, tag)
}
...
func TestVerifierSignerExternalAuthor(t *testing.T) {
	...
	tag, _, err := v.signer(t.Context(), space, "did:plc:external")
	require.NoError(t, err)
	require.Equal(t, spacecommit.HostProtocolTag, tag)
}
...
func TestVerifierSignerAuthorLookupError(t *testing.T) {
	...
	_, _, err := v.signer(t.Context(), space, "did:web:missing.example.com")
	require.Error(t, err)
...
func TestVerifierSignerAuthorNoKey(t *testing.T) {
	...
	_, _, err := v.signer(t.Context(), space, authorDID)
	require.Error(t, err)
...
func TestVerifierSignerExternalOwnerLookupError(t *testing.T) {
	...
	_, _, err := v.signer(t.Context(), space, "did:plc:external")
	require.Error(t, err)
