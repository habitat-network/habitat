...
export const FRUITS: Record<string, FruitMeta> = {
  ...
  melon: { emoji: "🍈", label: "Melon", colorVar: "--banana" },
  ...
  kiwi: { emoji: "🥝", label: "Kiwi", colorVar: "--lime-dark" },
  tomato: { emoji: "🍅", label: "Tomato", colorVar: "--cherry" },
  olive: { emoji: "🫒", label: "Olive", colorVar: "--lime-dark" },
  avocado: { emoji: "🥑", label: "Avocado", colorVar: "--lime-dark" },
};
