...
// against — rather than reimplementing the proof shape here. When credential
// is given, it's hashed into the "ath" claim, binding the proof to that
// specific delegation token/credential.
