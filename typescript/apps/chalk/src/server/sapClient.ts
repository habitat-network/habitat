...
// sealed code to trade for the resolved DID via redeemLogin) once the PDS
...
// redeemLogin trades the sealed code sap appended to a login's return_to for
...
// own seal and expiry on the code over its internal (authenticated)
